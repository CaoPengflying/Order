...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" >
		<div style="width: 400px;float: left">
			<table  class="easyui-datagrid" id="datagrid_places_employee" title="<%=name %>的常用送餐点" data-options="toolbar:'#toolbar_employee',striped:true"style="height:500px;">
				<thead>
					<tr>
		...
		<div style="width: 400px;float: left">
			<table  class="easyui-datagrid" id="datagrid_place_all" title="所有送餐点" data-options="toolbar:'#toolbar_all',striped:true,pagination:true"style="height:500px;">
				<thead>
					<tr>
						<th data-options="field:'selector',checkbox:true"></th>
						<th data-options="field:'name',width:150">送餐点</th>
