...
<body class="easyui-layout">
	...
	<div data-options="region:'center'" >
		<div style="width: 400px;float: left">
			<table  class="easyui-datagrid" id="datagrid_places_employee" title="<%=name %>的常用送餐点" data-options="toolbar:'#toolbar_employee',striped:true,checkOnSelect:true,selectOnCheck:false,singleSelect:true"style="height:500px;">
				<thead>
					<tr>
