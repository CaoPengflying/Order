...
<body class="easyui-layout">
	...
	<div data-options="region:'center',fit:true" >
		<div style="float: left">
			<table  class="easyui-datagrid" id="datagrid_places_employee" title="<%=user.getName() %>的常用送餐点" data-options="toolbar:'#toolbar_employee',striped:true,checkOnSelect:true,selectOnCheck:false,singleSelect:true"style="height:500px;">
				<thead>
					<tr>
		...
		<div id="toolbar_all" >			
			<a class="easyui-linkbutton" data-options="iconCls:'icon-back'" onclick="addPlaceToEmployee()">添加到职工送餐点列表</a>					
		</div>
	</div>		
