 ...
 *
 */
public class OrderTotalOnDepartmentOfCompany {
	...
	public String toString() {
		return "OrderTotalOnDepartmentOfCompany [departmentID=" + departmentID
				+ ", departmentName=" + departmentName + ", amountLunchNormal="
