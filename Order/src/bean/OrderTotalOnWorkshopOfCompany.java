...
public class OrderTotalOnWorkshopOfCompany {
	private short workshopID;//车间号
	...
	public String toString() {
		return "OrderTotalOnDepartmentOfCompany [workshopID=" + workshopID
				+ ", workshopName=" + workshopName + ", amountLunchNormal="
				+ amountLunchNormal + ", moneyLunchNormal=" + moneyLunchNormal
